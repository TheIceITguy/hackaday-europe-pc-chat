...
- Optional upside-down chat page for badges worn inverted. The chat F-buttons are mirrored in this mode so they line up with the rotated labels, and the nametag page always stays upright.
...
- Hidden shortcut: press Down three times quickly on the chat page to toggle upside-down chat mode.
